...
title('Maksymalna różnica między współczynnikami wielomianu - przypadki z wartościami funkcji liniowej');
xlabel('Rozmiar macierzy Vandermonde');
...
title('Maksymalna różnica między współczynnikami wielomianu - przypadki z zaburzonymi wartościami funkcji liniowej');
xlabel('Rozmiar macierzy Vandermonde');
ylabel('Maksymalna różnica współczynników');
grid on;
